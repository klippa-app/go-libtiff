...
import (
	...
	"github.com/klippa-app/go-libtiff/tiffinfo"
...
var _ = Describe("tiffinfo", func() {
	...
	It("shows the help text", func() {
		err := tiffinfo.Run(ctx, []string{"-help"})
		Expect(err).To(BeNil())
		Expect(stdout.String()).To(ContainSubstring("usage: tiffinfo"))
