...
import (
	...
	"github.com/klippa-app/go-libtiff/tiffdither"
...
var _ = Describe("tiffdither", func() {
	...
	It("shows the help text", func() {
		err := tiffdither.Run(ctx, []string{"-help"})
		Expect(err).To(BeNil())
		Expect(stdout.String()).To(ContainSubstring("usage: tiffdither"))
